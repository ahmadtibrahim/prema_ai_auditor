...
def scan(env):
    ...
    try:
        ...
        for mod in pending:
            issues.append({"category": "system", "code": "SYS_MODULE_PENDING", "risk": "medium",
                ...
                "detail": "Module '{}' is in state '{}'. Run upgrade to resolve.".format(mod["shortdesc"], mod["state"]),
    ...
    try:
        ...
        issues.append({"category": "system", "code": "SYS_SNAPSHOT", "risk": "low",
            ...
            "detail": "OS: {} | Python: {} | RAM: {}GB used / {}GB total ({}%) | Disk: {}GB used / {}GB total ({}%) | CPUs: {}".format(
        ...
        issues.append({"category": "system", "code": "SYS_SNAPSHOT", "risk": "low",
            "title": "Server Snapshot (partial)", "detail": "OS: {} | Python: {} | (psutil not available: {})".format(
